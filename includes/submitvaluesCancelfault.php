...
$service_type = 'Cancel Fault';


        $soapUrl = "https://www.wholesale.cyta.com.cy/OnlineOrderWS.asmx?op=CancelFault";
        ...
        $xml_post_string = '<?xml version="1.0" encoding="utf-8"?>
                            <soap:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/">
                              <soap:Body>
                              <CancelFault xmlns="http://tempuri.org/">
           ...
           $headers = array(
                        ...
                        "SOAPAction: \"http://tempuri.org/CancelFault\"",
               );
...
$re3 = $document->getElementsByTagName('ReferenceNumber');
$ResponseCode = '';
$ReasonCode = '';
$ReferenceNumber = '';
echo $ReasonCode;
