...
$premises_number = isset($_POST['premises_number']) ? $_POST['premises_number'] : '';
...
$premisesType = isset($_POST['premisesType']) ? $_POST['premisesType'] : '';
$additionalProducts = isset($_POST['additionalProducts']) ? $_POST['additionalProducts'] : '';
$Product = isset($_POST['Product']) ? $_POST['Product'] : '';
$PcatCode = isset($_POST['PcatCode']) ? $_POST['PcatCode'] : '';
$ProductSerial = isset($_POST['ProductSerial']) ? $_POST['ProductSerial'] : '';
$LoopRefNumber = isset($_POST['LoopRefNumber']) ? $_POST['LoopRefNumber'] : '';
$TerminationAtCustomer = isset($_POST['TerminationAtCustomer']) ? $_POST['TerminationAtCustomer'] : '';
$Info = isset($_POST['Info']) ? $_POST['Info'] : '';
$service_type = 'Place Order New';



$soapUrl = "https://www.wholesale.cyta.com.cy/OnlineOrderWS.asmx?op=PlaceOrderNew";
...
$xml_post_string = '<?xml version="1.0" encoding="utf-8"?>
                            <soap:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/">
                              <soap:Body>
                              <PlaceOrderNew xmlns="http://tempuri.org/">
                                ...
                                <premises_number>'.$premises_number.'</premises_number>
                                <building_name>'.$building_name.'</building_name>
                                <post_code>'.$post_code.'</post_code>
                                <Notes>'.$Notes.'</Notes>
                                <streetId>'.$streetId.'</streetId>
                                <premisesType>'.$premisesType.'</premisesType>
                                <additionalProducts>
                                    <Product>
                                        <PcatCode>'.$PcatCode.'</PcatCode>
                                        <ProductSerial>'.$ProductSerial.'</ProductSerial>
                                        <LoopRefNumber>'.$LoopRefNumber.'</LoopRefNumber>
                                        <TerminationAtCustomer>'.$TerminationAtCustomer.'</TerminationAtCustomer>
                                        <Info>'.$Info.'</Info>
                                    </Product>
                                </additionalProducts>
                              </PlaceOrderNew>
...
$headers = array(
    ...
    "SOAPAction: \"http://tempuri.org/PlaceOrderNew\"",
);
