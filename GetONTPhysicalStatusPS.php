...
require "index.php";
require "includes/submitvaluesGetONTPhysicalStatusPS.php"
?>
...
<head>
    ...
    <title>GetONTPhysicalStatusPS</title>
...
<header>
    <nav>
        <div class="left">
            <form id="myForm1" action="includes/submitvaluesGetONTPhysicalStatusPS.php" method="post">
