...
require "index.php";
require "includes/submitvaluesSearchForVectoring.php"
?>
...
<head>
    ...
    <title>Search for Vectoring</title>
...
<header>
    <nav>
        <div class="left">
            <form id="myForm1" action="includes/submitvaluesSearchForVectoring.php" method="post">
                <table style="float: left;">
                    ...
                    <tr>
                        ...
                        <td align="left"><input type="text" name="BuildingNumber" id="BuildingNumber"required /></td>
                    </tr>
