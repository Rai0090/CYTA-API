...
require "index.php";
require "includes/submitvaluesSearchForIPNode.php"
?>
...
<header>
    <nav>
        <div class="left">
            <form id="myForm1" action="includes/submitvaluesSearchForIPNode.php" method="post">
                <table style="float: left;">
                    <tr>
                        <td align="right">Network Element Name</td>
                        <td align="left"><input type="text" name="Network_Element_Name" id="Network_Element_Name"required /></td>
                    </tr>
