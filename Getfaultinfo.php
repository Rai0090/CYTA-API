...
require "index.php";
require "includes/submitvaluesGetfaultinfo.php"
?>
...
<header>
    <nav>
        <div class="left">
            <form id="myForm1" action="includes/submitvaluesGetfaultinfo.php" method="post">
                <table style="float: left;">
                    ...
                    <tr>
                        <td align="right">fault_reference_number</td>
                        <td align="left"><input type="text" name="fault_reference_number" id="fault_reference_number" /></td>
