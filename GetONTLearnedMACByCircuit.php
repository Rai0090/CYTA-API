...
require "index.php";
require "includes/submitvaluesGetONTLearnedMACByCircuit.php"
?>
...
<head>
    ...
    <title>GetONTLearnedMACByCircuit</title>
...
<header>
    <nav>
        <div class="left">
            <form id="myForm1" action="includes/submitvaluesGetONTLearnedMACByCircuit.php" method="post">
                <table style="float: left;">
                    ...
                    <tr>
                        ...
                        <td align="left"><input type="text" name="VLANID" id="VLANID"required /></td>
                    </tr>
