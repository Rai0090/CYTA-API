...
require "index.php";
require "includes/submitvaluesGetONTEthPerformanceByCircuit.php"
?>
...
<head>
    ...
    <title>GetONTEthPerformanceByCircuit</title>
...
<header>
    <nav>
        <div class="left">
            <form id="myForm1" action="includes/submitvaluesGetONTEthPerformanceByCircuit.php" method="post">
